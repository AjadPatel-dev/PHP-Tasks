...
Name :<br>
<input type="text" name="name" minlength="8"  value="<?php echo $name; ?>"><br><br>
<input type="hidden" name="id" value="<?php echo $id; ?>">
<input type="hidden" name="image" value="<?php echo $old_image; ?>">
<br>
Age :<br>
<input type="number" name="age" min="18" value="<?php echo $age; ?>"><br><br>
Profile Pic : <br>
<input type="file" name="pic" value="<?php echo $pic; ?>"><br><br>
Experience :<br>
<input type="number" name="experience" min="1" value="<?php echo $experience; ?>"><br><br>
...
<textarea name="address" id="add" rows="3" value="<?php echo $address; ?>" ></textarea><br>
